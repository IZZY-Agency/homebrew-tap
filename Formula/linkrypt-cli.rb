class LinkryptCli < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/IZZY-Agency/linkrypt/releases/download/cli-v1.0.0/linkrypt-aarch64-apple-darwin.tar.gz"
      sha256 "b97059501c688cb7e0a16e97be49e9f200757be1c70e68db1ca1ff9abbf2220a"
    end
    on_intel do
      url "https://github.com/IZZY-Agency/linkrypt/releases/download/cli-v1.0.0/linkrypt-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/IZZY-Agency/linkrypt/releases/download/cli-v1.0.0/linkrypt-aarch64-unknown-linux-musl.tar.gz"
      sha256 "6d0e941c7de60b4dc40657043f0abe87ceb9a598945cf7f7b84365156bf4b487"
    end
    on_intel do
      url "https://github.com/IZZY-Agency/linkrypt/releases/download/cli-v1.0.0/linkrypt-x86_64-unknown-linux-musl.tar.gz"
